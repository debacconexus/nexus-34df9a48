...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "World Cup 2026 Match Operations";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Match Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "match_record_records";
'use strict';
